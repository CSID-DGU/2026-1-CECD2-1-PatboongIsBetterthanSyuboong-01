...
| key | value |
| --- | --- |
| timestamp | 2026-05-07T17:45:34 |
| model_version | ae_squid_v1 |
| embedding_version | mock_pca_v1 |
| embedding_dim | 768 |
| similarity_weights | {"global": 1.0} |
| view_filter | (all) |
...
- **Top-1 any-match accuracy**: 0.6034
- **Top-3 any-match accuracy**: 0.9598

### 4.1 Per-disease recall

| disease | n | recall@1 | recall@3 |
| --- | ---: | ---: | ---: |
| lung_opacity | 119 | 0.563 | 0.992 |
| enlarged_cardiomediastinum | 107 | 0.252 | 0.907 |
| support_devices | 100 | 0.110 | 0.810 |
| atelectasis | 75 | 0.000 | 0.107 |
| cardiomegaly | 67 | 0.000 | 0.134 |
| pleural_effusion | 64 | 0.000 | 0.031 |
